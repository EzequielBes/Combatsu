...
- [x] SHOP-47 conferido: WHERE the debug mode is on and the URL has `noshop=1` THEN the next round SHALL start on the update after the shop opens, without crediting or removing any pickup.
